...
echo   "12. Yahoocloning              28. Instagram Brute Force";

echo   "13. BruteForce Facebook       29. Light_Bringer";

echo   "14. Bot Komen Facebook        30. Amer";

echo   "15. Auto Report Facebook      00. Exit";
echo ""
echo  "╭─choose" 
read -p "╰─>" pil;
